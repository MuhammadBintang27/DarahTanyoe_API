...
('6285277001001', 'Muhammad Rizki', 'Jl. Imam Bonjol No. 12, Meulaboh', ST_SetSRID(ST_MakePoint(96.1378, 4.1445), 4326)::geography, '1996-02-14', 'A+', true, true, CURRENT_DATE - INTERVAL '120 days', 5),
('6285277001002', 'Cut Mutia', 'Jl. Teuku Umar No. 45, Meulaboh', ST_SetSRID(ST_MakePoint(96.1342, 4.1408), 4326)::geography, '1999-06-20', 'O+', true, true, CURRENT_DATE - INTERVAL '95 days', 3),
('6285277001003', 'Teuku Ibrahim', 'Jl. Ahmad Yani No. 23, Suak Ribee', ST_SetSRID(ST_MakePoint(96.1392, 4.1398), 4326)::geography, '1992-10-08', 'B+', true, true, CURRENT_DATE - INTERVAL '100 days', 7),
('6285277001004', 'Safira Rahma', 'Jl. Merdeka No. 67, Meulaboh Kota', ST_SetSRID(ST_MakePoint(96.1325, 4.1452), 4326)::geography, '1997-04-11', 'AB+', true, true, NULL, 0),
('6285277001005', 'Daud Syahputra', 'Jl. Cut Nyak Dhien No. 89, Meulaboh', ST_SetSRID(ST_MakePoint(96.1405, 4.1410), 4326)::geography, '1994-12-03', 'A+', true, true, CURRENT_DATE - INTERVAL '85 days', 4);
...
INSERT INTO users (phone_number, full_name, address, location, date_of_birth, blood_type, active, phone_verified, last_donation_date, total_donations) VALUES
('6285277001006', 'Nurul Fadillah', 'Desa Meunasah Blang, Meulaboh', ST_SetSRID(ST_MakePoint(96.1198, 4.1523), 4326)::geography, '1998-08-25', 'B+', true, true, CURRENT_DATE - INTERVAL '110 days', 6),
('6285277001007', 'Yusuf Habibi', 'Gampong Pante Kuyun, Meulaboh', ST_SetSRID(ST_MakePoint(96.1512, 4.1356), 4326)::geography, '1995-01-19', 'O+', true, true, CURRENT_DATE - INTERVAL '90 days', 8),
('6285277001008', 'Rahmawati', 'Desa Alue Rambong, Johan Pahlawan', ST_SetSRID(ST_MakePoint(96.1145, 4.1589), 4326)::geography, '2000-03-07', 'A-', true, true, CURRENT_DATE - INTERVAL '105 days', 2),
